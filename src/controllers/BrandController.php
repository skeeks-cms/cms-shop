...
class BrandController extends Controller
{
     ...
     * @var string
     */
    public $modelClassName = ShopBrand::class;

    /**
     * @var string
     */
    public $editControllerRoute = "shop/admin-shop-brand";


    /**
     * @return bool|ShopBrand
     */
    ...
    protected function _initStandartMetaData()
    {
        ...
        if ($model->logo_image_id) {
            $imageAbsoluteSrc = $model->logo->absoluteSrc;
        }
