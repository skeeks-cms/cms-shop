 ...
 * @author Semenov Alexander <semenov@skeeks.com>
 */
class AdminShopCloudkassaController extends BackendModelStandartController
{
    public function init()
    {
        $this->name = \Yii::t('skeeks/cms', "Облачная касса");
        $this->modelShowAttribute = 'asText';
        $this->modelClassName = ShopCloudkassa::class;
            ...
            'index'  => [
                'on beforeRender' => function (Event $e) {
                    $e->content = Alert::widget([
                        ...
                        'body' => <<<HTML
<p>Для интеграции облачной кассы с сайтом!</p>
HTML
                        ,
                    ]);
                },
