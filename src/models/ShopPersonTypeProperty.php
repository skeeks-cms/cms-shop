...
class ShopPersonTypeProperty extends RelatedPropertyModel
{
    ...
    public function rules()
    {
        return ArrayHelper::merge(parent::rules(), [
            ...
            [
                [
                    'is_order_location_delivery',
                    'is_order_location_tax',
                    'is_order_postcode',
                    'is_user_email',
                    'is_user_phone',
                    'is_user_username',
            ...
            [
                ...
                'unique',
                'targetAttribute' => ['shop_person_type_id', 'code'],
                'message'         => 'Для данного типа плательщика этот код уже занят.',
            ],
        ]);
    }
    ...
    public function attributeLabels()
    {
        return array_merge(parent::rules(), [
            ...
            'is_order_location_tax'      => \Yii::t('skeeks/shop/app',
                'The value of the properties will be used as the location of the buyer to calculate the tax (only for type LOCATION)'),
            'is_order_postcode'          => \Yii::t('skeeks/shop/app',
                'The value of the properties will be used as the postcode for the buyer to calculate the cost of delivery'),
            'is_user_email'              => \Yii::t('skeeks/shop/app',
                'The value of the properties will be used as the E-Mail with the new user registration'),
            'is_user_phone'              => \Yii::t('skeeks/shop/app',
                'The value of the properties will be used as a phone when registering a new user'),
            'is_user_username'           => \Yii::t('skeeks/shop/app',
                'The value of the properties will be used as the login when registering a new user'),
            'is_user_name'               => \Yii::t('skeeks/shop/app',
                'The property value is used as a name when registering a new user'),
            'is_buyer_name'              => \Yii::t('skeeks/shop/app',
                'The value of the properties will be used as the name of the buyer profile'),
        ]);
    }
