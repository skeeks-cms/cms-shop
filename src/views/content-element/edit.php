...
<div class="row">
    <div class="col-md-3">
        <?= $form->field($model, 'baseProductPriceValue')->textInput()->label(\skeeks\cms\shop\Module::t('app',
                'Base price') . " (" . \skeeks\cms\shop\Module::t('app',
                'Price type') . " \"{$model->baseProductPrice->typePrice->name}\")"); ?>
    </div>
    <div class="col-md-2">
