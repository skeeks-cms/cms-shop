...
class m200822_100601__create_table__shop_type_price2auth_item extends Migration
{
    public function safeUp()
    {
        $tableName = 'shop_type_price2auth_item';
        ...
        $this->addCommentOnTable($tableName, 'Связь цены с ролью пользователя');
