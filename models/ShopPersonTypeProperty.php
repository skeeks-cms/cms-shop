...
class ShopPersonTypeProperty extends RelatedPropertyModel
{
    ...
    public function attributeLabels()
    {
        return array_merge(parent::rules(), [
            ...
            'searchable'                => \Yii::t('skeeks/shop/app', 'Searchable'),
            'filtrable'                 => \Yii::t('skeeks/shop/app', 'Filtrable'),
            ...
            'hint'                      => \Yii::t('skeeks/shop/app', 'Hint'),
            'smart_filtrable'           => \Yii::t('skeeks/shop/app', 'Smart Filtrable'),
